		...
		<section id="sectionAide">
			...
			<div id="tableauAide">
				<table>
					...
					<tbody>
						<tr>
							<td class="gauche" style="">Comment s'inscrire ?</td>
							<td class="droite">Vous devez vous rendre sur la page dedie (<a href="inscription.php">m'inscrire</a>).
						...
						<tr>
							<td class="gauche" >Vous avez perdu votre mot de passe ?</td>
							<td class="droite">Sur la page de connexion (<a href="connexion.php">ici</a>), en cliquant sur "Mot de passe oublié ?", 
						...
						<tr>
							<td class="gauche">Vous avez perdu votre adresse mail ?</td>
							<td class="droite">Dommage, mais nous ne pouvons récupérer votre compte. 
								Essayez tout de même de contacter le service client (<a href="contact.php">contacter</a>).
							</td>
						</tr>
						<tr>
							<td class="gauche">Comment modifier vos informations personnnelles ?</td>
							<td class="droite">En se connectant (<a href="connexion.php">se connecter</a>), dans l'onglet "Mes informations"
						...
						<tr>
							<td class="gauche">Comment ajouter des articles au panier ?</td>
							<td class="droite">Premièrement, se connecter à son compte (<a href="connexion.php">se connecter</a>).
								Ensuite, cliquer sur "ajouter dans mon panier" a cote de l'article.
								Vous aurez maintenant l'article choisit dans votre panier.
							</td>
						</tr>
						<tr>
							<td class="gauche">Comment suivre une commande ?</td>
							<td class="droite">En se connectant (<a href="connexion.php">se connecter</a>), dans l'onglet "Les Commandes"
						...
						<tr>
							<td class="gauche">Comment modifier ma commande ?</td>
							<td class="droite">En se connectant (<a href="connexion.php">se connecter</a>), dans l'onglet "Les Commandes"
								vous pouvez consulter toutes vos commandes.
						...
						<tr>
							<td class="gauche">Puis-je annuler ma commande ?</td>
							<td class="droite">L'annulation de la commande n'est pas possible tout le temps.
						...
						<tr>
							<td  class="gauche">Comment contacter un vendeur ?</td>
							<td class="droite">Lors que vous consultez un article, vous avez la possibilité d'envoyer un message au vendeur.
