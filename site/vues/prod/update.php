...
require_once(ROOT."inc/haut_site.php");
    ...
    ?>
    <article class="modification_article" style="">
        ...
        <div id="votre_article">
            <?php
            foreach($resultat as $article_actuel):
        ...
        <a class="btn_bas"  style="margin-left:130px;"href="produits/affichage">Retour à vos articles</a>
